...
Arg::Arg(const char *name, const char *desc, std::vector<std::string> definitions) : Arg::Arg(name, desc)
{
...
std::vector<std::string> Arg::getDefinitions() const
{
    return definitions;
}
...
CommandArgs::CommandArgs(std::vector<Arg *> args) : CommandArgs::CommandArgs()
{
